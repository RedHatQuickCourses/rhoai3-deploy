...
== Our Laboratory Model: granite-4.0-micro

To practice these concepts without requiring a massive GPU cluster, we will standardize on the **IBM granite-4.0-micro** model.
