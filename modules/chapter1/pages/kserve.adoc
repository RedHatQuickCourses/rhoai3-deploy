...
== Configuration: The Template and The Instance
...
spec:
  predictor:
    model:
      ...
      storageUri: "s3://models/granite3b/v1.0"
...
== Deployment Modes: Serverless vs. RawDeployment
...
== Day 2 Operations: Metrics & Observability
