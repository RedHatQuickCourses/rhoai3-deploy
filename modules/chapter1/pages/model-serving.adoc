...
In the previous modules, we selected the **Granite-2B** model and calculated the tuning parameters (`max-model-len=8192`) required to make it run safely on our hardware.
...
[source,bash]
----
MODEL_NAME="granite-2b-server"
MODEL_PATH="ibm-granite/granite-3.3-2b-instruct"
CONTEXT_LIMIT="8192"  # <--- Applying our sizing math from Module 2
----
