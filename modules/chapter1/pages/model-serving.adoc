...
In the previous modules, we selected the **Granite-4B-micro** model and calculated the tuning parameters (`max-model-len=8192`) required to make it run safely on our hardware.
